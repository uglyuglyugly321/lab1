...
//    #1.5 Дана сигнатура метода: public bool is2Digits (int x);
...
//1.7  Дана сигнатура метода: public bool isInRange (int a, int b, int num);
...
//    #1.9 Дана сигнатура метода: public bool isEqual(int a, int b, int c);
...
//    #2.1 Дана сигнатура метода: public int abs (int x);
...
//    #2.3 Дана сигнатура метода: public bool is35 (int x);
//    Необходимо реализовать метод таким образом, чтобы он возвращал true, если
...
//    #2.5 Дана сигнатура метода: public int max3 (int x, int y, int z);
...
//    #2.7 Дана сигнатура метода: public int sum2 (int x, int y);
...
//    #2.9 Дана сигнатура метода: public String day (int x);
...
//    #3.1 Дана сигнатура метода: public String listNums (int x);
...
//    #3.5 Дана сигнатура метода: public int numLen (long x);
...
//    #3.7 Дана сигнатура метода: public void square (int x);
...
//    #3.9 Дана сигнатура метода: public void rightTriangle (int x);
//    Необходимо реализовать метод таким образом, чтобы он выводил на экран
...
//                  ЗАДАНИЕ 4
//    #4.1 Дана сигнатура метода: public int findFirst (int[] arr, int x);
...
//    возвращается -1.
    ...
    //4.3 Дана сигнатура метода: public int maxAbs (int[] arr);
    //Необходимо реализовать метод таким образом, чтобы он возвращал
...
// 4.9 Дана сигнатура метода: public int[] findAll (int[] arr, int x);
//    Необходимо реализовать метод таким образом, чтобы он возвращал новый
